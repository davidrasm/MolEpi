...
The MCMC run took approximately 25 minutes to run on my laptop, so hopefully your run will finish before the end of class too! If its taking too long, you may want to download my pre-cooked [.log][precooked-log] and [.trees][precooked-trees] files.
